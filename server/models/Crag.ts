...
> {
  ...
  declare setClimbingTypes: BelongsToManySetAssociationsMixin<
    ClimbingType,
    number
  >;
  declare addClimbingType: BelongsToManyAddAssociationMixin<
    ClimbingType,
    number
  >;
  declare addClimbingTypes: BelongsToManyAddAssociationsMixin<
    ClimbingType,
    number
  >;
  declare createClimbingType: BelongsToManyCreateAssociationMixin<ClimbingType>;
  declare removeClimbingType: BelongsToManyRemoveAssociationMixin<
    ClimbingType,
    number
  >;
  declare removeClimbingTypes: BelongsToManyRemoveAssociationsMixin<
    ClimbingType,
    number
  >;
  declare hasClimbingType: BelongsToManyHasAssociationMixin<
    ClimbingType,
    number
  >;
  declare hasClimbingTypes: BelongsToManyHasAssociationsMixin<
    ClimbingType,
    number
  >;
