      ...
      >
        ...
        >
          ...
          <Box onClick={onOpen} display='flex' paddingTop='7px'>
            <Text noOfLines={[1]} marginBottom="5px" maxWidth="15vw" className="crag-name" as="b" fontSize="larger">
              {crag.name}
            </Text>
            <Box paddingLeft="7px" >
          ...
          <Box onClick={onOpen} display='flex' flexDirection='row' gap="3px" whiteSpace="nowrap" >
            <GiStoneBlock />
            <Text fontSize='small' >
          ...
          >
            <Box
              onClick={() => { setPieChartKeyModalFlag(true) }}
              flex="1"
              cursor="pointer"
            >
            ...
            <Box onClick={onOpen} flex="1">
              <WeatherComponent lat={crag.osy} lon={crag.osx} fullWeatherComponentFlag={false} daysFromNow={daysFromNow} />
            </Box>
          </Box>
        </CardBody>
      </Card>
